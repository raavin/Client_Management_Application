authorization do  
  role :admin do  
  has_permission_on [:clients, :services, :waiting_lists, :categories, :clients, :messages, :roles, :users, :authorization_rules, :case_notes, :expenditures], :to => [:index, :show, :new, :create, :edit, :update, :destroy]  
